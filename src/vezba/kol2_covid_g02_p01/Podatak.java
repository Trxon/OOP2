...
public class Podatak implements Serializable {
	...
	public Podatak(String dateString, String casesString, String deathsString, Zemlja country) {
		...
		this.cases = Integer.parseInt(casesString.trim());
		this.deaths = Integer.parseInt(deathsString.trim());
	...
	public String toString() {
		return String.format("%s | %d | %d | %s", date, cases, deaths, country.getCountry());
	}
}
