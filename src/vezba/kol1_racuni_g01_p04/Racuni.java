...
final class Racun {
	...
	public double getVisina() {
		return stavke.stream().collect(Collectors.summingDouble(s -> s.getCena() * s.getKolicina()));
	}
	...
	public String toString() {
		return String.format("[%05d] %s - visina : %.2f , uplaceno : %d", getBroj(), getVreme().toString(), getVisina(), getUplaceno());
	}
}
