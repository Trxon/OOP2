...
public final class Osoba {
	...
	/*
	 * U linijama koje se dobijaju statickom toString(Osoba osoba) met-
	 * odom nedostaje informacija da se rekonstruise lista dece tako da
	 * je taj deo ovde izostavljen.
	 */ 
		...
		return new Osoba(
				tokens[0].trim(),
				tokens[1].trim(),
				tokens[2].trim().equalsIgnoreCase("ZENSKI") ? Pol.ZENSKI : Pol.MUSKI,
				LocalDate.parse(tokens[3].trim(), DateTimeFormatter.ofPattern("uuuu-MM-dd")),
				tokens[4].trim(),
				tokens[5].trim(),
