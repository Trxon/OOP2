...
public class Cas implements Comparable<Cas> {
	...
	public Dan dan() 				{ return dan; 		}
	public LocalTime vremePoc() 	{ return vremePoc; 	}
	public LocalTime vremeKraj() 	{ return vremeKraj; }
	...
	public boolean equals(Object obj) {
		...
		if (!Objects.equals(this.dan, 		that.dan)) 			return false;
		if (!Objects.equals(this.vremePoc, 	that.vremePoc)) 	return false;
		if (!Objects.equals(this.vremePoc, 	that.vremePoc)) 	return false;
		if (!Objects.equals(this.predmet, 	that.predmet)) 		return false;
		if (!Objects.equals(this.nastavnik, that.nastavnik)) 	return false;
		if (!Objects.equals(this.tip, 		that.tip)) 			return false;
		if (!Objects.equals(this.sala, 		that.sala)) 		return false;
